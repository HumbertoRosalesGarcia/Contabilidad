...
interface FinanceDao {
    ...
    @Query("SELECT * FROM transactions WHERE country = :country AND cierreId = :cierreId ORDER BY timestamp DESC")
    fun getTransactionsByCierreId(country: String, cierreId: Int): Flow<List<Transaction>>

    @Query("SELECT * FROM comercio_movements WHERE country = :country AND cierreId = :cierreId ORDER BY timestamp DESC")
    fun getComercioMovementsByCierreId(country: String, cierreId: Int): Flow<List<ComercioMovement>>

    @Query("SELECT * FROM fiadores WHERE country = :country AND cierreId = :cierreId ORDER BY targetDateInMillis ASC")
    fun getFiadoresByCierreId(country: String, cierreId: Int): Flow<List<Fiador>>
