...
@Database(entities = [Transaction::class, Reminder::class, Fiador::class, Product::class, ComercioProduct::class, ComercioMovement::class, ComercioPedido::class, CierreSession::class], version = 25, exportSchema = false)
