...
import com.xxcamixx.contabilidad.data.MIGRATION_24_25
import com.xxcamixx.contabilidad.data.MIGRATION_25_26
import com.xxcamixx.contabilidad.data.MIGRATION_26_27

@Database(entities = [Transaction::class, Reminder::class, Fiador::class, Product::class, ComercioProduct::class, ComercioMovement::class, ComercioPedido::class, CierreSession::class], version = 27, exportSchema = false)
